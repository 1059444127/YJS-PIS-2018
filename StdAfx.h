...
#define ID_DLG_PRINTPREVIEW WM_USER + 300
#define ID_DLG_PRINT		WM_USER + 301
#define ID_BLK_BEGIN		WM_USER + 302 
#define ID_BUTTON_BBYYTIP	WM_USER + 360
#define ID_REPORT_CLOSE		WM_USER + 361
